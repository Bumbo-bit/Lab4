...
class Lab2 {
  public void linkedList() {
    ...
    Iterator<String> progIterator = progLanguages.iterator();
    
    while (progIterator.hasNext()) {
      String language = progIterator.next();
  ...
  public void queue() {
    ...
    System.out.print("Removed Element: " + removedElement+" ");
    // 10. View the head of the queue using peek(). Output it's value.
    String peekedElement = q.peek();
    System.out.print("Peeked Element: "+ peekedElement+" ");
  ...
  public void stack() {
    ...
    System.out.print(bookStack.search("Design Patterns"));
    // 19. Call empty(). Output the results
    System.out.print(bookStack.empty());
